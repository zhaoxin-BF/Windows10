<%@ Page Title="" Language="C#" MasterPageFile="~/Manange.Master" AutoEventWireup="true" CodeBehind="KindManage.aspx.cs" Inherits="CrazyForumSystem.views.KindManage" %>
          ...
          <%--  一系列按钮控件--%>
            <table style="font-size:70%;width: 100%;">
                <tr style="table-layout:fixed;width:33.33%;">
                    <td class="auto-style2">论坛版块管理</td>
